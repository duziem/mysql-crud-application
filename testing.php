...
/*	
	...
	$requiredfields=array("parishregno","title","sex","surname","baptismname","othernames","yearofbirth","monthofbirth","dayofbirth","placeofbirth","currentaddress","permaddress","stateoforigin","maritalstatus","yearofchurchmembership");//put all the required input fields into an array
	...
	function validation(){
		...
		/*
		$primaryoccupation = array();
		if(!in_array(@$_POST['primaryoccupation'],$primaryoccupation)){
			$_SESSION['error'][]='Enter a valid value in title field';
		}
		$secondaryoccupation = array();
		if(!in_array(@$_POST['secondaryoccupation'],$secondaryoccupation)){
			$_SESSION['error'][]='Enter a valid value in title field';
		}*/
		...
		if(!preg_match('/^.*$/',@$_POST['comments'])){
			$_SESSION['error'][]='Enter letters and whitespace only in Comments field';
		}*/
	}
...
<body>
	<div id="container">
			...
			<div style="padding-left:30px;">
				...
				<div id="regnoform" style="float:right;display:inline-block;font-weight:bold">Parish Registration no: <input id="regno" name="parishregno" autofocus type="text" size="8" form="parishioner_profileform" title="Accepts numbers only" style="height:22px;">
			...
			<form action="parishioner_profile.php" method="POST" style="padding-left:30px;" id="parishioner_profileform">
				...
				TITLE:<select disabled name="title" class="user_input" style="height:22px;margin-left:10px;text-transform:uppercase"/>
				...
				&nbsp;&nbsp;&nbsp;
				SEX:<select disabled name="sex" class="user_input" style="height:22px;margin-left:10px;text-transform:uppercase">
				...
				PLACE OF BIRTH:<input disabled size="70" name="placeofbirth" class="user_input" type="text" style="height:22px;margin-left:10px;text-transform:uppercase"/></input><br><br>
			...
			<form action="entryinterface.html" method="POST" style="padding-left:30px;">
				...
				<div style="display:flex;flex-direction:column;">
					<input form="parishioner_profileform" type="text" class="childrenname_input" size="70" name="nameofchildren1" style="height:22px;text-transform:uppercase"><br>
					<input form="parishioner_profileform" type="text" class="childrenname_input"  size="70" name="nameofchildren2" style="height:22px;text-transform:uppercase"><br>
					<input form="parishioner_profileform"  type="text" class="childrenname_input"  size="70" name="nameofchildren3" style="height:22px;text-transform:uppercase">
				</div><br><br>
				<div style="display:flex;flex-direction:column;margin-left:auto">
					<input form="parishioner_profileform"  type="text" class="childrenname_input" size="70" name="nameofchildren4" style="height:22px;text-transform:uppercase"><br>
					<input form="parishioner_profileform"  type="text" class="childrenname_input"  size="70" name="nameofchildren5" style="height:22px;text-transform:uppercase">
				</div>
				</div><br>
			...
			<div style="padding-left:30px;">
				<div style="display:flex;">
				<div style="display:flex;flex-direction:column;">
					<input form="parishioner_profileform" type="text" class="societiesname_input" size="70" name="nameofsocieties1" style="height:22px;text-transform:uppercase"><br>
					<input form="parishioner_profileform" type="text" class="societiesname_input"  size="70" name="nameofsocieties2" style="height:22px;text-transform:uppercase"><br>
					<input form="parishioner_profileform" type="text" class="societiesname_input"  size="70" name="nameofsocieties3" style="height:22px;text-transform:uppercase">
				</div><br><br>
				<div style="display:flex;flex-direction:column;margin-left:auto">
					<input form="parishioner_profileform" type="text" class="societiesname_input" size="70" name="nameofsocieties4" style="height:22px;text-transform:uppercase"><br>
					<input form="parishioner_profileform" type="text" class="societiesname_input"  size="70" name="nameofsocieties5" style="height:22px;text-transform:uppercase"><br>
					<input form="parishioner_profileform" type="text" class="societiesname_input"  size="70" name="nameofsocieties6" style="height:22px;text-transform:uppercase">
				</div>
				</div><br><br>
	...
	<script>
		...
		childrennumber[1].onclick= function(){
			childrenname_input[0].disabled= "";
			childrenname_input[1].disabled= "";
		}
		childrennumber[2].onclick= function(){
			childrenname_input[0].disabled= "";
			childrenname_input[1].disabled= "";
			childrenname_input[2].disabled= "";
		}
		childrennumber[3].onclick= function(){
			childrenname_input[0].disabled= "";
			childrenname_input[1].disabled= "";
			childrenname_input[2].disabled= "";
			childrenname_input[3].disabled= "";
		}
		...
		societynumber[1].onclick= function(){
			societiesname_input[0].disabled= "";
			societiesname_input[1].disabled= "";
		};
		societynumber[2].onclick= function(){
			societiesname_input[0].disabled= "";
			societiesname_input[1].disabled= "";
			societiesname_input[2].disabled= "";
		};
		societynumber[3].onclick= function(){
			societiesname_input[0].disabled= "";
			societiesname_input[1].disabled= "";
			societiesname_input[2].disabled= "";
			societiesname_input[3].disabled= "";
		};
		societynumber[4].onclick= function(){
			...
			societiesname_input[2].disabled= "";
			societiesname_input[3].disabled= "";
			societiesname_input[4].disabled= "";
		};
		societynumber[5].onclick= function(){
			...
			societiesname_input[3].disabled= "";
			societiesname_input[4].disabled= "";
			societiesname_input[5].disabled= "";
		};
	</script>
</body>
</html>