<?php
	...
	if(isset($_POST['fullname'])&&!empty($_POST['fullname'])&&isset($_POST['baptismnumber'])&&!empty($_POST['baptismnumber'])){
			$fullname= strtoupper($_POST['fullname']);
			$baptismnumber= strtoupper($_POST['baptismnumber']);
		
		//$regno= $_SESSION['regno'];
		
		//$query= "SELECT * FROM `baptism_table` WHERE `Fullname`='$fullname' AND `Regno`='$regno'";
		$query= "SELECT DISTINCT * FROM `baptism_table` WHERE `fullname`='$fullname' AND `Baptismnumber`='$baptismnumber'";
